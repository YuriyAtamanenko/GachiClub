import{m as _t,d as p,E as Wt,o as Gt,s as Yt,p as C,_ as qt,f as ae,q as y,h as Xt,u as lt,b as xe,t as Kt,j as x,I as pe,v as ue,n as I,P as q,w as Qt,x as Zt}from"./index-18247b10.js";import{s as z}from"./styled-components.browser.esm-3026bbb2.js";import{_ as ct,f as Jt,a as en,b as tn,c as nn,e as rn}from"./createClass-3aac7284.js";import{r as Ce}from"./react-responsive-0dcbfc9c.js";function on(n,t){if(n==null)return{};var i={},r=Object.keys(n),e,a;for(a=0;a<r.length;a++)e=r[a],!(t.indexOf(e)>=0)&&(i[e]=n[e]);return i}var S=function(t,i){var r=arguments;if(i==null||!_t.call(i,"css"))return p.createElement.apply(void 0,r);var e=r.length,a=new Array(e);a[0]=Wt,a[1]=Gt(t,i);for(var u=2;u<e;u++)a[u]=r[u];return p.createElement.apply(null,a)};function Re(){for(var n=arguments.length,t=new Array(n),i=0;i<n;i++)t[i]=arguments[i];return Yt(t)}var an=function(){var t=Re.apply(void 0,arguments),i="animation-"+t.name;return{name:i,styles:"@keyframes "+i+"{"+t.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}};const un="/GachiClub/assets/products-desktop-1x-e8c375a5.jpg",sn="/GachiClub/assets/products-desktop-2x-85e8f868.jpg",ln=z.div`
...
`,at=[{value:null,label:"All"},{value:"false",label:"Recommended "},{value:"true",label:"Not recommended"}],io=()=>{var w;const n=lt(),t=(w=xe(Gr))==null?void 0:w.map(E=>({value:E,label:qr(E)}));p.useEffect(()=>{n(Kt())},[n]);const i=Ce.useMediaQuery({minWidth:375}),r=Ce.useMediaQuery({minWidth:769}),e=Ce.useMediaQuery({minWidth:1440});let a="",u="";i?(a="40px",u="156px"):(a="40px",u="183px"),r?(a="52px",u="204px"):a="52px",a="48px";const o={control:E=>({...E,backgroundColor:"trasparent",width:u,height:a,appearance:"none",WebkitAppearance:"none",MozAppearance:"none"}),option:(E,{isFocused:F,isSelected:M})=>({...E,fontSize:"14px",lineHeight:"18px",backgroundColor:"rgba(28, 28, 28, 1)",color:M?"#E6533C":"#EFEDE8",padding:"14px"}),menu:E=>({...E,backgroundColor:"rgba(28, 28, 28, 1)"}),singleValue:E=>({...E,color:"#EFEDE8"}),indicatorSeparator:E=>({...E,backgroundColor:"transparent"}),dropdownIndicator:E=>({...E,color:"#EFEDE8"}),container:E=>({...E,border:"1px solid rgba(239, 237, 232, 0.30)",borderRadius:"12px",outline:"none",fontSize:"14px",lineHeight:"18px"}),menuList:E=>({...E,borderRadius:"12px","::-webkit-scrollbar":{display:"none"},overflowY:"scroll"})},[s,l]=p.useState(!1),[c,d]=p.useState(""),[m,b]=p.useState(""),[v,g]=p.useState(at[0]),f=E=>{const F=E.target.value;l(F.length>0),d(F),n(ue({search:F,category:m.value,recommended:v.value}))},h=E=>{b(E),n(ue({category:E.value,search:c,recommended:v.value}))},O=E=>{g(E),n(ue({recommended:E.value,search:c,category:m.value}))},D=()=>{d(""),n(ue({search:"",category:m.value,recommended:v.value})),l(!1)};return x.jsxs(Xr,{children:[x.jsx(no,{children:"Filters"}),x.jsx("li",{children:x.jsxs(Qr,{children:[x.jsx(Kr,{value:c,onChange:f,name:"productSearch",type:"text",placeholder:"Search"}),x.jsx(eo,{onClick:D,style:{display:s?"block":"none"},type:"button",children:x.jsx(to,{children:x.jsx("use",{xlinkHref:`${pe}#icon-close`})})}),x.jsx(Zr,{type:"button",children:x.jsx(Jr,{children:x.jsx("use",{xlinkHref:`${pe}#icon-search`})})})]})}),x.jsx("li",{children:x.jsx("div",{children:x.jsx(ot,{value:m,onChange:h,theme:E=>({...E,colors:{...E.colors,primary50:"rgba(255, 255, 255, 0.10)",primary:"transparent",neutral40:"#EFEDE8",neutral20:"transparent",neutral30:"transparent",neutral50:"rgba(239, 237, 232, 1)",neutral80:"rgba(239, 237, 232, 1)"}}),styles:o,options:t||[]})})}),x.jsx("li",{children:x.jsx("div",{children:x.jsx(ot,{value:v,onChange:O,options:at,theme:E=>({...E,colors:{...E.colors,primary50:"rgba(255, 255, 255, 0.10)",primary:"transparent",neutral40:"#EFEDE8",neutral20:"transparent",neutral30:"transparent",neutral50:"rgba(239, 237, 232, 1)",neutral80:"rgba(239, 237, 232, 1)"}}),styles:o})})})]})},ro=I.ul`
  display: flex;
...
`,Do=n=>{const t=n;let i=t.getDate(),r=t.getMonth()+1;const e=t.getFullYear();return i<10&&(i="0"+i),r<10&&(r="0"+r),i+"-"+r+"-"+e};function $t({data:n,closeModal:t,addProduct:i}){const[r,e]=p.useState(0),a=Math.round(r*n.calories/100),u=Do(new Date);return x.jsx(go,{children:x.jsxs("form",{children:[x.jsxs(bo,{children:[x.jsx("label",{children:x.jsx(xo,{type:"text",value:n.title,disabled:!0})}),x.jsx("label",{children:x.jsx(Eo,{placeholder:"grams",type:"number",value:r,onChange:o=>e(o.target.value)})})]}),x.jsxs(Co,{children:[x.jsx(So,{children:"Calories:"})," ",a]}),x.jsxs(Fo,{children:[x.jsx(yo,{type:"button",onClick:()=>i({id:n.id,date:u,amount:r,calories:a}),children:"Add to diary"}),x.jsx(wo,{type:"button",onClick:t,children:"Cancel"})]})]})})}$t.propTypes={data:q.object,closeModal:q.func,addProduct:q.func};const jt=({info:n})=>{const[t,i]=p.useState(!1),r=xe(Qt),e=()=>{i(a=>!a)};return x.jsxs(ao,{children:[x.jsxs(uo,{children:[x.jsx(so,{children:"DIET"}),x.jsx(lo,{style:{backgroundColor:`${n.groupBloodNotAllowed[r]?"#E9101D":"#419B09"}`}}),x.jsx(co,{children:n.groupBloodNotAllowed[r]?"Not recommended":"Recommended"}),x.jsxs(po,{type:"button",onClick:e,children:["Add",x.jsx(fo,{width:16,height:16,children:x.jsx("use",{href:pe+"#icon-arrow-right"})})]})]}),x.jsxs(ho,{children:[x.jsx("svg",{width:24,height:24,fill:"orange",children:x.jsx("use",{href:pe+"#icon-runningOnCircle"})}),x.jsx(mo,{children:n.title.length>20?`${n.title.slice(0,20)}...`:n.title})]}),x.jsxs(vo,{children:[x.jsxs(Ae,{children:["Calories: ",x.jsx(Me,{children:n.calories})]}),x.jsxs(Ae,{children:["Category:"," ",x.jsx(Me,{children:n.category.length>10?`${n.category.slice(0,10)}...`:n.category})]}),x.jsxs(Ae,{children:["Weight: ",x.jsx(Me,{children:n.weight})]})]}),t&&x.jsx($t,{closeAddModal:e,data:n})]})};jt.propTypes={info:q.shape({title:q.string.isRequired,category:q.string.isRequired,weight:q.number.isRequired,calories:q.number,groupBloodNotAllowed:q.shape({})}).isRequired};const Oo=()=>{const n=xe(Wr);return x.jsx(ro,{children:n.length>0?n.slice(0,25).map(t=>x.jsx(jt,{info:t},t._id)):x.jsxs(oo,{children:[x.jsxs(ut,{children:[x.jsx(st,{children:"Sorry, no results were found "}),"for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),x.jsx(ut,{children:x.jsx(st,{children:"Try changing the search parameters."})})]})})},Po=()=>{const n=lt(),t=xe(Yr);return p.useEffect(()=>{n(Zt(t))},[n,t]),x.jsxs(ln,{children:[x.jsxs(dn,{children:[x.jsx(cn,{children:"Products"}),x.jsx(io,{})]}),x.jsx(Oo,{})]})};export{Po as default};
