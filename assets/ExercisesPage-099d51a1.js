import{P as c,j as e,u as p,C as R,D as q,F as T,c as g,b as h,G,H as Q,I as m,J as _,K as f,M as $,O as S,L as ee}from"./index-1755ba82.js";import{s as t}from"./styled-components.browser.esm-3fdf310e.js";import{r as D}from"./react-responsive-0abc8740.js";const te=i=>i.exercises.title,ie=i=>i.exercises.category,ne=i=>i.exercises.isToggled,oe=i=>i.exercises.exerciseIndex,re=i=>i.exercises.isSuccess,se=i=>i.exercises.modalIsOpen,ae=i=>i.exercises,ce=i=>i.exercises.allExercises,le=t.h1`
  margin-bottom: 20px;
  color: #efede8;
  font-family: Roboto;
  font-size: 24px;
...
`,F=({imgURL:i,name:o,filter:s,id:r})=>{const n=p(),a=(d,l)=>{n(R(l)),n(q()),d==="Body parts"?n(T({bodyPartTitle:l,equipmentTitle:"",targetTitle:""})):d==="Muscles"?n(T({bodyPartTitle:"",equipmentTitle:"",targetTitle:l})):d==="Equipment"&&n(T({bodyPartTitle:"",equipmentTitle:l,targetTitle:""}))};return e.jsx(de,{onClick:()=>a(s,o),children:e.jsxs(xe,{children:[e.jsx(pe,{src:i,alt:o}),e.jsxs(he,{children:[e.jsx(ge,{children:o}),e.jsx(me,{children:s})]})]})})};F.propTypes={imgURL:c.string,name:c.string,filter:c.string};const B=t.div`
  display: flex;
...
`;function Y({itemsPerPage:i,category:o}){const s=D.useMediaQuery({minWidth:768,maxWidth:1439.8}),[r,n]=g.useState(1),a=p(),l=h(ae)[o||"bodyparts"],x=Math.ceil(l.length/i),y=j=>{n(j)},b=(r-1)*i,C=b+i,E=l.slice(b,C);return g.useEffect(()=>{a(G())},[a]),e.jsxs(B,{children:[e.jsx(be,{children:E.map(({filter:j,name:u,imgURL:N,_id:W})=>e.jsx(F,{id:W,imgURL:N,name:u,filter:j},W))}),l.length>10||s?e.jsx("div",{style:{display:"inline-flex",justifyContent:"center",marginRight:8},children:Array.from({length:x},(j,u)=>e.jsx("input",{type:"radio",name:"active-page",onClick:()=>y(u+1),className:r===u+1?"active":""},u))}):null]})}const P=({page:i})=>{const o=D.useMediaQuery({minWidth:768,maxWidth:1439.8});return e.jsx(B,{children:e.jsx("div",{children:e.jsx(Y,{category:i,itemsPerPage:o?9:10})})})};P.propTypes={page:c.string};Y.propTypes={itemsPerPage:c.number,category:c.string};const ue="_container_rxzv8_1",fe="_category_rxzv8_8",ye="_activecategory_rxzv8_23 _category_rxzv8_8",je="_categorygroup_rxzv8_41",we="_categoryitem_rxzv8_48",w={container:ue,category:fe,activecategory:ye,categorygroup:je,categoryitem:we},ve=[{title:"Body parts",route:"bodyparts"},{title:"Muscules",route:"muscules"},{title:"Equipments",route:"equipments"}],ke=()=>{const[i,o]=g.useState(""),s=p();return g.useEffect(()=>{o(0)},[]),e.jsx("div",{className:w.container,children:e.jsx("ul",{className:w.categorygroup,children:ve.map(({title:r,route:n},a)=>e.jsx("li",{className:w.categoryitem,children:e.jsx("button",{className:`${a===i?w.activecategory:w.category}`,onClick:()=>{s(Q(n)),o(a)},children:r})},a))})})},ze=t.li`
  border: 1px solid rgba(239, 237, 232, 0.2);
  border-radius: 12px;
