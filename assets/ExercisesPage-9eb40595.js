import{P as c,j as e,u as b,F as R,G as q,H as L,r as h,b as g,J as Q,K as _,I as m,M as $,O as f,S as ee,T as w,L as te}from"./index-12b2046d.js";import{s as t}from"./styled-components.browser.esm-6110fb3a.js";import{r as D}from"./react-responsive-694727af.js";const ie=i=>i.exercises.title,ne=i=>i.exercises.category,oe=i=>i.exercises.isToggled,re=i=>i.exercises.exerciseIndex,se=i=>i.exercises.isSuccess,ae=i=>i.exercises.modalIsOpen,ce=i=>i.exercises,le=i=>i.exercises.allExercises,de=t.h1`
  margin-bottom: 20px;
  color: #efede8;
  font-family: Roboto;
  font-size: 24px;
...
`,F=({title:i})=>e.jsx(de,{children:i||"Exercises"});F.propTypes={title:c.string};const xe=t.li`
...
`,B=({imgURL:i,name:o,filter:s})=>{const n=b(),r=(a,l)=>{n(R(l)),n(q()),a==="Body parts"?n(L({bodyPartTitle:l.toString().toLowerCase(),equipmentTitle:"",targetTitle:""})):a==="Muscles"?n(L({bodyPartTitle:"",equipmentTitle:"",targetTitle:l.toString().toLowerCase()})):a==="Equipment"&&n(L({bodyPartTitle:"",equipmentTitle:l.toString().toLowerCase(),targetTitle:""}))};return e.jsx(xe,{onClick:()=>r(s,o),children:e.jsxs(pe,{children:[e.jsx(he,{src:i,alt:o}),e.jsxs(ge,{children:[e.jsx(me,{children:o}),e.jsx(be,{children:s})]})]})})};B.propTypes={imgURL:c.string,name:c.string,filter:c.string};const Y=t.div`
  display: flex;
