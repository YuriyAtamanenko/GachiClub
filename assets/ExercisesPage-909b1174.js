import{P as a,j as e,u as h,z as T,A as K,b,d as p,B as O,C as Z,I as u,D as J,F as f,G as N,H as C,L as G,J as Q}from"./index-ba5d3eed.js";import{s as t}from"./styled-components.browser.esm-edaf4470.js";import{r as _}from"./react-responsive-c3167b8a.js";const $=i=>i.exercises.title,ee=i=>i.exercises.category,te=i=>i.exercises.isToggled,ie=i=>i.exercises.exerciseIndex,ne=i=>i.exercises.isSuccess,oe=i=>i.exercises.modalIsOpen,re=i=>i.exercises,se=i=>i.exercises.allExercises,ce=t.h1`
  margin-bottom: 20px;
  color: #efede8;
  font-family: Roboto;
  font-size: 24px;
...
`,Le=t.span`
  ...
  align-items: center;
`,q=({name:i,burnedCalories:n,bodyPart:r,target:s,index:o})=>{const c=h();return e.jsxs(ve,{children:[e.jsx(ke,{children:"WORKOUT"}),e.jsxs(ze,{children:[e.jsx(Le,{children:e.jsx("svg",{width:"24",height:"24",style:{fill:"#EFEDE8",zIndex:10},children:e.jsx("use",{href:u+"#icon-running"})})}),e.jsx(Se,{children:i})]}),e.jsxs(Ce,{children:[e.jsxs(E,{children:["Burned calories: ",e.jsx(L,{children:n})]}),e.jsxs(E,{children:["Body part: ",e.jsx(L,{children:r})]}),e.jsxs(E,{children:["Target: ",e.jsx(L,{children:s})]})]}),e.jsxs(Ee,{type:"button",onClick:()=>{c(J(o)),c(f())},children:["Start",e.jsx("svg",{width:16,height:16,style:{verticalAlign:"top",stroke:"#E6533C"},children:e.jsx("use",{href:u+"#icon-next"})})]})]})};q.propTypes={name:a.string,burnedCalories:a.number,bodyPart:a.string,target:a.string,index:a.number};const Ue=t.div`
  display: flex;
  @media screen and (min-width: 1440px) {
    max-height: 726px;
  }
...
`,We="_overlay_y08h9_1",Te="_overlayhidden_y08h9_20",U={overlay:We,overlayhidden:Te},B=({children:i})=>{const n=b(oe),r=h();p.useEffect(()=>{const o=c=>{c.code==="Escape"&&r(f())};return document.addEventListener("keydown",o),()=>{document.removeEventListener("keydown",o)}},[r]);const s=o=>{o.target===o.currentTarget&&r(f())};return e.jsx("div",{className:`${n?U.overlayhidden:U.overlay}`,onClick:s,children:i})};B.propTypes={children:a.object};const Ke=t.div`
  width: 335px;
  z-index: 5;
  display: flex;
  position: relative;
...
`,xt=()=>{const i=b(te),n=b(ee),r=b($),s=h();return e.jsxs(rt,{children:[i&&e.jsxs(st,{onClick:()=>{s(K()),s(T("Exercises"))},children:[e.jsx("svg",{width:16,height:16,style:{stroke:"rgba(239, 237, 232, 0.4)"},children:e.jsx("use",{href:u+"#icon-back"})}),"Back"]}),e.jsxs(ct,{children:[e.jsx(V,{title:r}),e.jsx(we,{})]}),i?e.jsx(ot,{}):e.jsx(F,{page:n})]})};export{xt as default};
