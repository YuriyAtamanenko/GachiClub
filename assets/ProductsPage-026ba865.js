import{m as qt,c as p,E as Xt,o as Kt,s as Qt,p as C,_ as Zt,f as ue,q as F,h as Jt,u as Re,b as xe,t as en,j as v,I as oe,v as se,n as M,w as pt,x as tn,P as H,L as Ue,y as nn,z as rn,A as on}from"./index-1755ba82.js";import{s as $}from"./styled-components.browser.esm-3fdf310e.js";import{_ as ft,f as an,a as un,b as sn,c as ln,e as cn}from"./createClass-8ddea681.js";import{r as Ce}from"./react-responsive-0abc8740.js";function dn(n,t){if(n==null)return{};var i={},r=Object.keys(n),e,a;for(a=0;a<r.length;a++)e=r[a],!(t.indexOf(e)>=0)&&(i[e]=n[e]);return i}var S=function(t,i){var r=arguments;if(i==null||!qt.call(i,"css"))return p.createElement.apply(void 0,r);var e=r.length,a=new Array(e);a[0]=Xt,a[1]=Kt(t,i);for(var u=2;u<e;u++)a[u]=r[u];return p.createElement.apply(null,a)};function Le(){for(var n=arguments.length,t=new Array(n),i=0;i<n;i++)t[i]=arguments[i];return Qt(t)}var pn=function(){var t=Le.apply(void 0,arguments),i="animation-"+t.name;return{name:i,styles:"@keyframes "+i+"{"+t.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}};const fn="/GachiClub/assets/products-desktop-1x-e8c375a5.jpg",hn="/GachiClub/assets/products-desktop-2x-85e8f868.jpg",mn=$.div`
...
`;pt.defaults.baseURL="https://fitness-for-all-back-end.onrender.com";const Ro=tn("dairy/addProduct",async n=>{const{productId:t,calories:i,amount:r}=n,{data:e}=await pt.post("diary/addProduct",{productId:t,calories:i,amount:r});return{data:e}});function Ut({data:n,closeAddModal:t,openSuccessModal:i,setAmoutnCalories:r}){const e=Re(),[a,u]=p.useState(0),o=Math.round(a*n.calories/100),s=()=>{if(!o){console.log("Must be greater than 0");return}const l={productId:n._id,calories:o,amount:a};return e(Ro(l)),r(o),t(),i(),o};return v.jsx(Fo,{children:v.jsxs("form",{children:[v.jsxs(wo,{children:[v.jsx("label",{children:v.jsx(Do,{type:"text",value:n.title,disabled:!0})}),v.jsx("label",{children:v.jsx(Oo,{placeholder:"grams",type:"number",value:a,onChange:l=>u(l.target.value)})})]}),v.jsxs(Ao,{children:[v.jsx(Mo,{children:"Calories:"})," ",o]}),v.jsxs(Io,{children:[v.jsx(Vo,{type:"button",onClick:s,children:"Add to diary"}),v.jsx(Po,{type:"button",onClick:t,children:"Cancel"})]})]})})}Ut.propTypes={data:H.object,closeAddModal:H.func,addProduct:H.func,openSuccessModal:H.func,setAmoutnCalories:H.func};const Lo="/GachiClub/assets/avocado-2x-1cf208a8.png",To=M.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  z-index: 10;
...
`,Uo=M.svg`
  ...
  height: 16px;
  stroke: #efede8;
`,Nt=({closeSuccessModal:n,calories:t})=>v.jsx(To,{children:v.jsxs(ko,{children:[v.jsxs(Bo,{children:[v.jsx(Ho,{src:Lo,alt:"avocado"}),v.jsx(jo,{children:"Well done"}),v.jsxs(dt,{children:["Calories:"," ",v.jsx($o,{children:t})]})]}),v.jsx(Ue,{to:"/products",children:v.jsx(zo,{onClick:n,children:"Next product"})}),v.jsx(Ue,{to:"/diary",children:v.jsxs(dt,{children:["To the diary",v.jsx(Uo,{children:v.jsx("use",{href:oe+"icon-right",children:" "})})]})})]})});Nt.propTypes={closeSuccessModal:H.func,calories:H.number};const _t=({info:n})=>{const[t,i]=p.useState(0),[r,e]=p.useState(!1),[a,u]=p.useState(!1),o=xe(nn),s=()=>{e(c=>!c)},l=()=>{u(c=>!c)};return v.jsxs(ho,{children:[v.jsxs(mo,{children:[v.jsx(go,{children:"DIET"}),v.jsx(vo,{style:{backgroundColor:`${n.groupBloodNotAllowed[o]?"#E9101D":"#419B09"}`}}),v.jsx(bo,{children:n.groupBloodNotAllowed[o]?"Not recommended":"Recommended"}),v.jsxs(xo,{type:"button",onClick:s,children:["Add",v.jsx(Eo,{width:16,height:16,children:v.jsx("use",{href:oe+"#icon-arrow-right"})})]})]}),v.jsxs(Co,{children:[v.jsx("svg",{width:24,height:24,fill:"orange",children:v.jsx("use",{href:oe+"#icon-runningOnCircle"})}),v.jsx(So,{children:n.title.length>20?`${n.title.slice(0,20)}...`:n.title})]}),v.jsxs(yo,{children:[v.jsxs(Ae,{children:["Calories: ",v.jsx(Me,{children:n.calories})]}),v.jsxs(Ae,{children:["Category:"," ",v.jsx(Me,{children:n.category.length>10?`${n.category.slice(0,10)}...`:n.category})]}),v.jsxs(Ae,{children:["Weight: ",v.jsx(Me,{children:n.weight})]})]}),r&&v.jsx(Ut,{setAmoutnCalories:i,closeAddModal:s,openSuccessModal:l,data:n}),a&&v.jsx(Nt,{closeSuccessModal:l,calories:t})]})};_t.propTypes={info:H.shape({title:H.string.isRequired,category:H.string.isRequired,weight:H.number.isRequired,calories:H.number,groupBloodNotAllowed:H.shape({})}).isRequired};const No=()=>{const n=xe(Zr);return v.jsx(po,{children:n.length>0?n.slice(0,20).map(t=>v.jsx(_t,{info:t},t._id)):v.jsxs(fo,{children:[v.jsxs(lt,{children:[v.jsx(ct,{children:"Sorry, no results were found "}),"for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),v.jsx(lt,{children:v.jsx(ct,{children:"Try changing the search parameters."})})]})})},qo=()=>{const n=Re(),t=xe(eo),[i,r]=p.useState(!0);return p.useEffect(()=>{n(rn(t)).then(()=>{r(!1)})},[n,t]),v.jsxs(mn,{children:[v.jsxs(vn,{children:[v.jsx(gn,{children:"Products"}),v.jsx(co,{})]}),i?v.jsx(bn,{children:v.jsx(on,{})}):v.jsx(No,{})]})};export{qo as default};
